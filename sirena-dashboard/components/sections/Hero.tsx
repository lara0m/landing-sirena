  ...
  return (
    ...
    >
      <div className="max-w-[720px]">
        <h1 className="bg-gradient-to-r from-[#256F7D] to-[#2E8B9C] bg-clip-text text-[40px] font-bold leading-tight text-transparent">
          Predicción de inundaciones con IA
        </h1>
        <p className="mt-4 text-[16px] text-zinc-800">
          Anticipamos las inundaciones, prevenimos riesgos
        </p>
        <div className="mt-5 inline-block rounded-full bg-gradient-to-r from-[#256F7D] to-[#2E8B9C] p-[2px]">
          <a
            href="#mapa"
